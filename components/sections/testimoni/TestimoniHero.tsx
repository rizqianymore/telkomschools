    ...
    <section className="border-b border-neutral-200/80 bg-neutral-50/60 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span>Kisah & Pengalaman Nyata</span>
        </Badge>
        <h1 className="text-4xl font-extrabold tracking-tight text-neutral-900 sm:text-5xl">
          Cerita Sukses & <span className="text-primary">Testimoni</span>
        </h1>
        <p className="mt-4 max-w-2xl mx-auto text-base sm:text-lg text-neutral-600 leading-relaxed">
          Pengalaman autentik dari siswa, orang tua, dan alumni yang telah berkarya di industri teknologi nasional maupun internasional.
        </p>
      </div>
    </section>
  )
